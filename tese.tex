...
\title{
    ...
    titlept={Design de Proteínas e Aprendizado Profundo: Uma nova fronteira no tratamento da Hemofilia B},
    titleen={Protein Design and Deep Learning: A New Frontier in Hemophilia B Management},
...
\begin{longtable}{rl}
  ...
  $Er_{0}$ & Erro inicial\\
  $P_{val}$ & Conjunto de posições válidas na sequência de aminoácidos para sofrer mutação durante o treinamento \\
  $R_{val}$ & Conjunto de resíduos válidos para serem utilizados na mutação durante o treinamento\\
  $N_{rep}$ & Número máximo de vezes que um resíduo pode ser utilizado em uma mutação ao longo de um mesmo episódio durante o treinamento\\
  $M_{max}$ & Número máximo de mutações que podem ser realizadas em um mesmo episódio durante o treinamento\\
