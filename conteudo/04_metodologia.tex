...
A partir desses resultados, foi realizada uma análise comparativa entre os peptídeos derivados das proteínas otimizadas e do FIX nativo.
...
e a frequência com que os alelos ocorrem na natureza são as métricas utilizadas para avaliar e comparar a imunogenicidade das proteínas geradas com a proteína nativa \ref{section:imuno_resultados}. 
